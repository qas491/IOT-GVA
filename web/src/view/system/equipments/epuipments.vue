...
onMounted(async () => {
  try {
    ...
    map = new amap.Map(mapContainer.value, {
      ...
      zoom: 4, // 初始化地图级别
      center: [105.0000, 38.0000] // 初始化地图中心点位置
    });
...
const getDeviceIcon = (status) => {
  ...
  return new AMap.Icon({
    ...
    image: `data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3Ccircle cx='50' cy='50' r='50' fill='${color}'/%3E%3C/svg%3E`,
