  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt"width="180">
            ...
            <el-table-column sortable align="left" label="安装地点" prop="installationLocation" width="120" />

            <el-table-column align="left" label="详细位置" prop="detailedLocation" width="120" />

            <el-table-column sortable align="left" label="所在城市" prop="city" width="120" />

            <el-table-column sortable align="left" label="更新日期" prop="updateDate" width="180">
   <template #default="scope">{{ formatDate(scope.row.updateDate) }}</template>
    ...
    {{ detailFrom.installationLocation }}
</el-descriptions-item>
                    <el-descriptions-item label="详细位置">
    {{ detailFrom.detailedLocation }}
</el-descriptions-item>
